...
module.exports = {
  ...
  JLT: (args) => opcodes.JLT | (reg[args[0]] << SOURCE_SHIFT) | (reg[args[1]] << DESTINATION_SHIFT) | (args[2] << ADDRESS_SHIFT),
  MOV: (args) => opcodes.MOV | (reg[args[0]] << DESTINATION_SHIFT) | (reg[args[1]] << SOURCE_SHIFT),
  LDV: (args) => opcodes.LDV | (reg[args[0]] << DESTINATION_SHIFT) | (reg[args[1]] << SOURCE_SHIFT) | (args[2] << ADDRESS_SHIFT),
  LDR: (args) => opcodes.LDR | (reg[args[0]] << DESTINATION_SHIFT) | (args[1] << ADDRESS_SHIFT),
  LDM: (args) => opcodes.LDM | (reg[args[0]] << SOURCE_SHIFT) | (args[1] << ADDRESS_SHIFT),
